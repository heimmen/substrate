...
const (
	...
	// A bucket in an S3-compatible object store synced with a node-local
	// directory bind-mounted into the actor: atelet rehydrates the mounted
	// directory from the bucket when it is empty, exports it back
	// periodically (and at checkpoint time), and binds it into the guest.
	VolumeType_VOLUME_TYPE_OBJECT_STORE_BUCKET VolumeType = 3
)
...
var (
	VolumeType_name = map[int32]string{
		...
		3: "VOLUME_TYPE_OBJECT_STORE_BUCKET",
	}
...
// ObjectStoreBucketVolumeSource carries the resolved (per-actor) object-store
// bucket configuration for one objectStoreBucket volume: ateapi resolves the
// template's Secret reference and derives the per-actor bucket name before
// sending this to atelet over the Run/Checkpoint/Restore RPCs. atelet never
// reads namespace Secrets.
type ObjectStoreBucketVolumeSource struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// S3-compatible endpoint URL (e.g. "http://minio.default.svc:9000").
	...
	// Resolved per-actor bucket name (bucketPrefix + actor name).
	Bucket string `protobuf:"bytes,4,opt,name=bucket,proto3" json:"bucket,omitempty"`
	// Periodic export cadence in seconds; 0 uses the atelet default (20).
...
func (x *ObjectStoreBucketVolumeSource) Reset() {
	*x = ObjectStoreBucketVolumeSource{}
	mi := &file_atelet_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ObjectStoreBucketVolumeSource) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ObjectStoreBucketVolumeSource) ProtoMessage() {}

func (x *ObjectStoreBucketVolumeSource) ProtoReflect() protoreflect.Message {
	mi := &file_atelet_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ObjectStoreBucketVolumeSource.ProtoReflect.Descriptor instead.
func (*ObjectStoreBucketVolumeSource) Descriptor() ([]byte, []int) {
	return file_atelet_proto_rawDescGZIP(), []int{7}
}

func (x *ObjectStoreBucketVolumeSource) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *ObjectStoreBucketVolumeSource) GetAccessKeyId() string {
	if x != nil {
...
func (x *ObjectStoreBucketVolumeSource) GetSecretAccessKey() string {
	if x != nil {
...
func (x *ObjectStoreBucketVolumeSource) GetBucket() string {
	if x != nil {
		return x.Bucket
	}
	return ""
...
func (x *ObjectStoreBucketVolumeSource) GetExportIntervalSeconds() int32 {
	if x != nil {
...
func (x *Volume) GetObjectStoreBucket() *ObjectStoreBucketVolumeSource {
	if x != nil {
		if x, ok := x.Source.(*Volume_ObjectStoreBucket); ok {
...
type Volume_ObjectStoreBucket struct {
	ObjectStoreBucket *ObjectStoreBucketVolumeSource `protobuf:"bytes,5,opt,name=object_store_bucket,json=objectStoreBucket,proto3,oneof"`
}
...
func (*Volume_ObjectStoreBucket) isVolume_Source() {}
...
const file_atelet_proto_rawDesc = "" +
	...
	"volumeType\"\xdb\x01\n" +
	"\x1dObjectStoreBucketVolumeSource\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpoint\x12\"\n" +
	"\raccess_key_id\x18\x02 \x01(\tR\vaccessKeyId\x12*\n" +
	"\x11secret_access_key\x18\x03 \x01(\tR\x0fsecretAccessKey\x12\x16\n" +
	"\x06bucket\x18\x04 \x01(\tR\x06bucket\x126\n" +
	"\x17export_interval_seconds\x18\x05 \x01(\x05R\x15exportIntervalSeconds\"\xa0\x02\n" +
	"\x06Volume\x12\x12\n" +
	...
	"durableDir\x12:\n" +
	"\bexternal\x18\x04 \x01(\v2\x1c.atelet.ExternalVolumeSourceH\x00R\bexternal\x12W\n" +
	"\x13object_store_bucket\x18\x05 \x01(\v2%.atelet.ObjectStoreBucketVolumeSourceH\x00R\x11objectStoreBucketB\b\n" +
	"\x06source\"@\n" +
	...
	"\x05scope\x18\v \x01(\x0e2\x15.atelet.SnapshotScopeR\x05scopeB\b\n" +
	"\x06config\"\x11\n" +
	"\x0fRestoreResponse*\x85\x01\n" +
	"\n" +
	"VolumeType\x12\x1b\n" +
	"\x17VOLUME_TYPE_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17VOLUME_TYPE_DURABLE_DIR\x10\x01\x12\x18\n" +
	"\x14VOLUME_TYPE_EXTERNAL\x10\x02\x12#\n" +
	"\x1fVOLUME_TYPE_OBJECT_STORE_BUCKET\x10\x03*j\n" +
...
var file_atelet_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_atelet_proto_goTypes = []any{
	...
	(*ObjectStoreBucketVolumeSource)(nil),   // 10: atelet.ObjectStoreBucketVolumeSource
	(*Volume)(nil),                          // 11: atelet.Volume
	(*VolumeMount)(nil),                     // 12: atelet.VolumeMount
	(*Container)(nil),                       // 13: atelet.Container
	(*EnvEntry)(nil),                        // 14: atelet.EnvEntry
	(*Readyz)(nil),                          // 15: atelet.Readyz
	(*HTTPGetAction)(nil),                   // 16: atelet.HTTPGetAction
	(*RunResponse)(nil),                     // 17: atelet.RunResponse
	(*LocalCheckpointConfiguration)(nil),    // 18: atelet.LocalCheckpointConfiguration
	(*ExternalCheckpointConfiguration)(nil), // 19: atelet.ExternalCheckpointConfiguration
	...
	nil,                                     // 24: atelet.ArchAssets.FilesEntry
	nil,                                     // 25: atelet.SandboxAssets.AssetsEntry
}
var file_atelet_proto_depIdxs = []int32{
	...
	24, // 2: atelet.ArchAssets.files:type_name -> atelet.ArchAssets.FilesEntry
	25, // 3: atelet.SandboxAssets.assets:type_name -> atelet.SandboxAssets.AssetsEntry
	13, // 4: atelet.WorkloadSpec.containers:type_name -> atelet.Container
	11, // 5: atelet.WorkloadSpec.volumes:type_name -> atelet.Volume
	...
	10, // 9: atelet.Volume.object_store_bucket:type_name -> atelet.ObjectStoreBucketVolumeSource
	14, // 10: atelet.Container.env:type_name -> atelet.EnvEntry
	15, // 11: atelet.Container.readyz:type_name -> atelet.Readyz
	12, // 12: atelet.Container.volume_mounts:type_name -> atelet.VolumeMount
	16, // 13: atelet.Readyz.http_get:type_name -> atelet.HTTPGetAction
	7,  // 14: atelet.CheckpointRequest.spec:type_name -> atelet.WorkloadSpec
	1,  // 15: atelet.CheckpointRequest.type:type_name -> atelet.CheckpointType
	18, // 16: atelet.CheckpointRequest.local_config:type_name -> atelet.LocalCheckpointConfiguration
	19, // 17: atelet.CheckpointRequest.external_config:type_name -> atelet.ExternalCheckpointConfiguration
	2,  // 18: atelet.CheckpointRequest.scope:type_name -> atelet.SnapshotScope
	7,  // 19: atelet.RestoreRequest.spec:type_name -> atelet.WorkloadSpec
	1,  // 20: atelet.RestoreRequest.type:type_name -> atelet.CheckpointType
	18, // 21: atelet.RestoreRequest.local_config:type_name -> atelet.LocalCheckpointConfiguration
	19, // 22: atelet.RestoreRequest.external_config:type_name -> atelet.ExternalCheckpointConfiguration
	2,  // 23: atelet.RestoreRequest.scope:type_name -> atelet.SnapshotScope
	4,  // 24: atelet.ArchAssets.FilesEntry.value:type_name -> atelet.AssetFile
	5,  // 25: atelet.SandboxAssets.AssetsEntry.value:type_name -> atelet.ArchAssets
	3,  // 26: atelet.AteomHerder.Run:input_type -> atelet.RunRequest
	20, // 27: atelet.AteomHerder.Checkpoint:input_type -> atelet.CheckpointRequest
	22, // 28: atelet.AteomHerder.Restore:input_type -> atelet.RestoreRequest
	17, // 29: atelet.AteomHerder.Run:output_type -> atelet.RunResponse
	21, // 30: atelet.AteomHerder.Checkpoint:output_type -> atelet.CheckpointResponse
	23, // 31: atelet.AteomHerder.Restore:output_type -> atelet.RestoreResponse
