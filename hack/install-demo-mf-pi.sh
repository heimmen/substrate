...
# Resolve the MinIO root credentials in the same order as deploy.sh: an
...
demo-mf-pi_usage() {
  ...
  echo "  Optional env: MFPI_WORKER_REPLICAS (default 4; max concurrently-active users), MINIO_ROOT_USER, MINIO_ROOT_PASSWORD, MINIO_IMAGE"
