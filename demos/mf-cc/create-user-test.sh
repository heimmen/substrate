...
#
# Idempotently create a user (one mf-cc actor) in the TEST environment
# (atespace mfcc-test, template ate-demo-mf-cc-test/mf-cc). If the actor
...
ATESPACE="${MFCC_ATESPACE:-mfcc-test}"
TEMPLATE="ate-demo-mf-cc-test/mf-cc"
