...
#
# Idempotently create a user (one mf-cc actor). If the actor already exists,
# reuse it — its session history lives in the actor's durableDir and is
# preserved. This satisfies "no instance -> create; instance exists -> reuse".
